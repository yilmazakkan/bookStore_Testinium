...
CREATE TABLE `bookstore` (
  ...
  `book_store_name` varchar(255) DEFAULT NULL,
  `book_store_city` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `bookstore` VALUES (1,'Pandora Kitapevi','istanbul'),(2,'D&R','Ankara');
...
-- Dump completed on 2020-03-02  4:02:16
